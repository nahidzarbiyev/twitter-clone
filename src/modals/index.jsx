...
export default function Modal() {
  ...
  const currentModal = modals.find((elem) => elem.name === modal.name);
  return (<div className="fixed inset-0 bg-[color:var(--background-modal)]  flex items-center justify-center z-20">
