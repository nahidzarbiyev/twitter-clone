  ...
  return (
    ...
    >
      ...
      <Popover className={"absolute top-1.5 right-2"}>
        <Popover.Button
          type="button"
          className="outline-none w-[34.75px] h-[34.75px] rounded-full  flex items-center justify-center hover:bg-[#1d9bf01a] hover:text-[#1d9bf0] transition-colors"
        >
          <svg
            viewBox="0 0 24 24"
            fill="currentColor"
        ...
        <Popover.Panel
          className={
            "w-[384px] absolute top-2 right-0 overflow-hidden bg-[color:var(--background-primary)] rounded-xl  shadow-box z-[1]"
          }
        >
          <button className="hover:bg-white/[0.05] transition-colors w-full py-3 px-4 flex items-center justify-start gap-3 text-[15px] leading-5 font-bold ">
            <svg
              viewBox="0 0 24 24"
              fill="currentColor"
              width={18.75}
          ...
          <button className=" hover:bg-white/[0.05] transition-colors w-full py-3 px-4 flex items-center justify-start gap-3 text-left   text-[15px] leading-5 font-bold ">
            <svg
              viewBox="0 0 24 24"
              fill="currentColor"
              width={18.75}
